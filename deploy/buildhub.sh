...
case $JUPYTERHUB_SSL in
    ...
    use_ssl_le)
        ...
        chmod a+x ./letsencrypt/app/cert_status
        chmod a+x ./letsencrypt/app/entrypoint.sh
        chmod a+x ./letsencrypt/app/force_renew
        chmod a+x ./letsencrypt/app/functions.sh
        chmod a+x ./letsencrypt/app/letsencrypt_service
        chmod a+x ./letsencrypt/app/signal_le_service
        chmod a+x ./letsencrypt/app/start.sh
        ;;
esac
