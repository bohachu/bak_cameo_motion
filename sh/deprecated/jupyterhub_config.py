...
c.JupyterHub.db_url = 'postgresql://postgres:Q!w2e3r4@localhost/jupyterhub'
...
# c.LocalAuthenticator.add_user_cmd = ['adduser','-q','--gecos','""','--home','/myhub/USERNAME -p $(openssl passwd -6 USERNAME)']
